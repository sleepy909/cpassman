...
$txt['bugs_page'] = "Si vous découvrais un bug, vous pouvez directement le reporter dans la section <a href='http://code.google.com/p/cpassman/issues/list' target='_blank'><u>Bugs</u></a>.";
$txt['by'] = "par";
$txt['cancel'] = "Annuler";
...
$txt['email_text_new_user'] = "Bonjour,<br /><br />Votre compte a été créé dans cPassMan.<br />Vous pouvez maintenant accéder à \".$cpassman_url.\" en utilisant les informations de connexion suivants : <br />";
