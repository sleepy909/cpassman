...
$txt['admin_action_check_pf'] = "Actualiser les Répertoires Personnels des utilisateurs (les créer s'ils n'existent pas)";
...
$txt['admin_action_db_clean_items_tip'] = "Cela supprime tous les éléments associés à un répertoire ayant été supprimés. Pensez à faire une sauvegarde avant.";
...
$txt['admin_settings_title'] = "Paramètres de cPassMan";
...
$txt['alert_message_personal_sk_missing'] = "Vous devez saisir votre clé personnelle !";
$txt['all'] = "tous";
...
$txt['auteur'] = "Auteur";
$txt['author'] = "Auteur";
$txt['authorized_groups'] = "Répertoires autorisés";
...
$txt['bugs_page'] = "Si vous découvrez un bug, vous pouvez directement le rapporter dans la section <a href='http://code.google.com/p/cpassman/issues/list' target='_blank'><u>Bugs du Forum</u></a>.";
$txt['by'] = "par";
$txt['cancel'] = "Annuler";
...
$txt['change_forbidden_groups'] = "Changer les répertoires interdits";
$txt['change_function'] = "Changer les rôles associés";
$txt['change_group_autgroups_info'] = "Sélection des répertoires autorisés associés à la rôle";
$txt['change_group_autgroups_title'] = "Paramétrage des répertoires autorisés";
$txt['change_group_forgroups_info'] = "Sélection des répertoires interdits associés à la rôle";
$txt['change_group_forgroups_title'] = "Paramétrage des répertoires interdits";
$txt['change_user_autgroups_info'] = "Sélection des répertoires autorisés associés au compte";
$txt['change_user_autgroups_title'] = "Paramétrage des répertoires autorisés";
$txt['change_user_forgroups_info'] = "Sélection des répertoires interdits associés au compte";
$txt['change_user_forgroups_title'] = "Paramétrage des répertoires interdits";
$txt['change_user_functions_info'] = "Sélection des rôles associés au compte";
$txt['change_user_functions_title'] = "Paramétrage des rôles associés";
...
$txt['confirm_delete_group'] = "Êtes-vous sûr de vouloir supprimer ce répertoire ainsi que tous les éléments inclus ?";
$txt['confirm_deletion'] = "Êtes-vous sûr de vouloir supprimer cet élément ?";
...
$txt['del_function'] = "Supprimer le Rôle";
...
$txt['email_subject_new_user'] = "[cPassMan] Création d\'un compte";
$txt['email_text_new_user'] = "Bonjour,<br /><br />Votre compte a été créé dans cPassMan.<br />Vous pouvez maintenant accéder à \".$cpassman_url.\" en utilisant les informations de connexion suivantes : <br />";
...
$txt['error_must_enter_all_fields'] = "Vous devez saisir chaque champ !";
...
$txt['error_no_password'] = "Vous devez renseigner votre identifiant et mot de passe !";
...
$txt['error_salt'] = "<b>La CLÉ de cryptage est trop longue! Merci de ne pas utiliser l'outil tant qu'un Administrateur n'a pas modifié la CLÉ de cryptage.</b> Dans le fichier settings.php, la longueur maximum autorisé pour SALT est 32 caractères.";
...
$txt['forbidden_groups'] = "Répertoires interdits";
...
$txt['forgot_pw_email_body'] = "Bonjour,<br /><br />Votre nouveau mot de passe pour cPassMan est :";
$txt['forgot_pw_email_body'] = "Bonjour,<br /><br />Votre nouveau mot de passe pour cPassMan est : ";
...
$txt['forgot_pw_email_subject_confirm'] = "cPassMan - Votre mot de passe - étape 2";
$txt['functions'] = "Rôles";
$txt['function_alarm_no_group'] = "Ce Rôle n'est associé à aucun Répertoire!";
...
$txt['give_function_title'] = "Ajouter un nouveau Rôle";
$txt['give_new_email'] = "Merci de préciser le nouvel email";
$txt['give_new_login'] = "Merci de préciser l'identifiant";
...
$txt['import_csv_anyone_can_modify_in_role_txt'] = "Permettre la modification des éléments importés par n'importe qui ayant le même rôle.";
$txt['import_csv_anyone_can_modify_txt'] = "Permettre la modification des éléments importés par n'importe qui.";
$txt['import_csv_dialog_info'] = "Information : l'importation nécessite un fichier CSV. Un fichier exporté depuis Keepass a le format requis. Si vous désirez importer des données exportées depuis un autre outil, merci de vous assurer que ce dernier a la structure suivante : `Titre`,`Identifiant`,`Mot de passe`,`Site Web`,`Commentaires`.";
...
$txt['import_error_no_read_possible_kp'] = "Lecture du fichier impossible ! Il ne semble pas être généré par KeePass.";
$txt['import_keepass_dialog_info'] = "Cette fonctionnalité d'importation ne fonctionne qu'avec un fichier XML généré depuis KeePass ! Notez que le script d'importation n'importera pas les répertoires et/ou éléments qui existent déjà dans l'arbre.";
$txt['import_keepass_to_folder'] = "Choisir le répertoire de destination";
$txt['import_kp_finished'] = "L'importation depuis KeePass est maintenant termin&eacute;e !<br />Par d&eacute;faut, le niveau de complexit&eacute; des nouveaux r&eacute;pertoires a &eacute;t&eacute; d&eacute;fini &agrave; 'Moyen'. Vous devriez peut-être le changer en fonction de vos besoins.";
...
$txt['index_change_pw'] = "Changer votre mot de passe";
...
$txt['label'] = "Intitulé";
$txt['last_items_icon_title'] = "Montrer/Cacher les derniers éléments consultés";
$txt['last_items_title'] = "Derniers éléments consultés";
$txt['level'] = "Niveau";
...
$txt['login_copy'] = "Copier l'identifiant de connexion dans le Presse-Papier";
$txt['logs'] = "Journaux";
...
$txt['personal_salt_key'] = "Votre clé personnelle";
$txt['personal_salt_key_empty'] = "Clé non saisie !";
$txt['personal_salt_key_info'] = "Cette clé sera utilisée pour crypter et décrypter votre mot de passe.<br />Elle n'est pas sauvée en base de données et elle est seulement connue de vous.<br />Ne la perdez surtout pas !";
...
$txt['settings_anyone_can_modify_tip'] = "<span style='font-size:11px;max-width:300px;'>Quand activé, cela ajoute une option dans la fiche de création et d'édition de l'élément qui permet à l'auteur d'autoriser la modification de l'élément par tout utilisateur.</span>";
$txt['settings_kb'] = "Activer la Base de Connaissance (bêta)";
$txt['settings_kb_tip'] = "<span style='font-size:11px;max-width:300px;'>Quand activé, cela ajoute la possibilité de créer votre propre Base de Connaissance au travers d'une page dédiée.</span>";
...
$txt['settings_ldap_mode_tip'] = "N'activer que si vous avez un serveur LDAP et si vous l'utilisez pour authentifier les utilisateurs de cPassMan.";
$txt['settings_ldap_ssl'] = "Connexion SSL de votre LDAP (LDAPS)";
$txt['settings_ldap_tls'] = "Connexion TLS de votre LDAP";
$txt['settings_log_connections'] = "Activer la sauvegarde en base de données des connexions utilisateurs.";
...
$txt['settings_printing_tip'] = "Quand activé, un bouton est ajouté à la page d\'accueil permettant à l\'utilisateur d\'imprimer un listing PDF des éléments auxquels il a accès. Attention, cette liste laisse apparaître les mots de passe sans cryptage.";
...
$txt['settings_send_stats_tip'] = "Ces statistiques sont anonymes !<br /><span style='font-size:10px;max-width:300px;'>Aucune adresse IP ou information privée ne sont collectés. Seules les informations suivantes sont récupérées : Nb objets, Nb répertoires, Nb utilisateurs, la version de cPassMan, option Répertoires Persos, option LDAP.<br />Un grand merci pour toute activation de ces statistiques qui nous permettent une meilleure compréhension de votre utilisation de cPassMan.</span>";
$txt['show'] = "Afficher";
...
$txt['user_alarm_no_function'] = "Cet utilisateur n'a aucun Rôle associé !";
