...
$txt['bugs_page'] = "Herhangi bir hata bulursanız, direk olarak <a href='http://code.google.com/p/cpassman/issues/list' target='_blank'><u>Hata</u></a> gönderebilirsiniz.";
$txt['by'] = "Tarafından";
$txt['cancel'] = "Vazgeç";
...
$txt['error_salt'] = "<b>SALT Anahtarı çok uzun! Lütfen yönetici SALT anahtarını değiştirene kadar cPassMan kullanmayınız.</b> settings.php dosyasında, SALT anahtarı 32 karakterden uzun olamaz.";
...
$txt['print_out_pdf_title'] = "cPassMan - dışarı aktarılmış öğelerin listesi";
