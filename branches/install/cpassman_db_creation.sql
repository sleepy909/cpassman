CREATE TABLE IF NOT EXISTS `cpm_functions` (
...
CREATE TABLE IF NOT EXISTS `cpm_items` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cpm_log_items` (
...
CREATE TABLE IF NOT EXISTS `cpm_misc` (
...
CREATE TABLE IF NOT EXISTS `cpm_nested_tree` (
...
CREATE TABLE IF NOT EXISTS `cpm_rights` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
