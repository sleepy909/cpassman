...
$txt['admin_misc_cpassman_dir'] = "Полный путь к cPassMan";
$txt['admin_misc_cpassman_url'] = "Полный URL к cPassMan";
...
$txt['admin_settings_title'] = "Настройки cPassMan";
...
$txt['bugs_page'] = "Если вы обнаружили ошибку, вы можете сообщить о ней <a href='http://code.google.com/p/cpassman/issues/list' target='_blank'><u>сюда</u></a>.";
$txt['by'] = "by";
$txt['cancel'] = "Отмена";
...
$txt['index_maintenance_mode_admin'] = "Активирован режим обслуживания. Пользователи не могут пользоваться cPassMan.";
...
$txt['settings_maintenance_mode'] = "Перевести cPassMan в режим обслуживания";
...
$txt['symbols'] = "Symbols";
$txt['tags'] = "Tags";
$txt['thku'] = "Спасибо за использование cPassMan!";
