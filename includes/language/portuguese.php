...
$txt['admin_misc_cpassman_dir'] = "Caminho absoluto do cPassMan";
$txt['admin_misc_cpassman_url'] = "Caminho URL do cPassMan";
...
$txt['admin_settings_title'] = "Configurações cPassMan";
...
$txt['bugs_page'] = "Se você encontrar um bug poderá postar diretamente em <a href='http://code.google.com/p/cpassman/issues/list' target='_blank'><u>Bugs</u></a>.";
$txt['by'] = "por";
$txt['cancel'] = "Cancelar";
...
$txt['email_subject_new_user'] = "[cPassMan] Sua conta";
$txt['email_text_new_user'] = "Oi,<br /><br />Sua conta foi criada em cPassMan.<br />Agora você pode acessar $cpassman_url usando as seguintes credenciais:<br />";
...
$txt['error_cpassman_dir'] = "Nenhum diretorio definido para cPassMan. Por favor, selecione na aba de configurações no menu do administrador.";
$txt['error_cpassman_url'] = "Nenhum URL definido para cPassMan. Por favor, selecione na aba de configurações no menu do administrador.";
...
$txt['forgot_pw_email_altbody_1'] = "Oi, A sua identificação para o cPassMan é:";
$txt['forgot_pw_email_body'] = "Oi,<br /><br />Sua nova senha do cPassMan é:";
$txt['forgot_pw_email_body'] = "Oi,<br><br>Sua nova senha do cPassMan é:";
$txt['forgot_pw_email_body_1'] = "Oi, As suas credenciais para o cPassMan é:";
$txt['forgot_pw_email_subject'] = "cPassMan - Sua senha";
$txt['forgot_pw_email_subject_confirm'] = "[cPassMan] Sua senha, passo 2";
...
$txt['index_maintenance_mode_admin'] = "Modo de manutenção esta ativo. Usuários não podem usar o cPassMan";
...
$txt['print_out_pdf_title'] = "cPassMan - Lista de itens exportados";
...
$txt['settings_ldap_mode_tip'] = "Habilitar somente se você tiver um servidor LDAP e se você quiser usá-lo para autenticas os usuários cPassMan através dele.";
...
$txt['settings_maintenance_mode'] = "Coloca cPassMan em modo de manutenção";
...
$txt['settings_send_stats'] = "Enviar estatísticas mensais ao autor para compreender melhor seu uso de cPassMan";
$txt['settings_send_stats_tip'] = "Estas estatísticas são totalmente anônimos <br /> <span style='font-size:10px;max-width:300px;'> O seu IP não será enviado, apenas os seguintes dados são transmitidos: quantidade de itens, pastas, usuários versão cPassman, pastas pessoais habilitado, ldap habilitado obrigado. <br /> Muitos se você permitir que essas estatísticas. Por isso, você me ajudar a desenvolver ainda mais cPassMan. </ Span>";
...
$txt['tags'] = "Tags";
$txt['thku'] = "Obrigado por usar cPassMan!";
...
$txt['update_needed_mode_admin'] = "E recomendável você atualizar o seu cPassMan";
