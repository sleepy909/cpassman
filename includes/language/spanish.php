...
$txt['admin_action_db_backup_key_tip'] = "Por favor ingrese la clave de encriptacion. Guardela en algun lado, se le pedira para una restauracion. (dejar en blanco para no encriptar)";
...
$txt['admin_action_db_clean_items'] = "Remover elementos huerfanos de la base de datos";
...
$txt['admin_action_db_restore_tip'] = "Se ha hecho usando un archivo de resguardo de SQL creado por la funcion de resguardo";
...
$txt['admin_action_reload_cache_table'] = " ";
$txt['admin_action_reload_cache_table_tip'] = "Permite recargar todo el contenido de la tabla de Cache. Algunas veces Puede ser útil.";
...
$txt['admin_setting_activate_expiration_tip'] = "Si esta activado, los elementos expirados no le seran mostrados a los usuarios";
...
$txt['associated_role'] = "Que rol asociar a esta carpeta:";
...
$txt['change_group_forgroups_info'] = "Seleccionar las carpetas prohibidas a las que este Rol no puede ver ni usar";
...
$txt['change_user_forgroups_info'] = "Seleccionar las carpetas prohibidas que esta cuenta no puede ver ni acceder";
...
$txt['confirm_deletion'] = "Esta por eliminar... esta seguro?";
$txt['confirm_del_account'] = "Ha decidido borrar esta Cuenta. Esta seguro?";
$txt['confirm_del_from_fav'] = "Por favor confirma la eliminacion de Favoritos";
$txt['confirm_del_role'] = "Por favor confirme la eliminacion del siguiente rol:";
$txt['confirm_edit_role'] = "Por favor ingrese el nombre del siguiente rol:";
...
$txt['email_subject_new_user'] = "[cPassMan] Su creación de cuenta";
...
$txt['error_cpassman_dir'] = "No hay una ruta establecida para cPassMan. Por favor, seleccionar el tab 'Seteos de cPassMan' en la pagina de seteos para Admins.";
...
$txt['give_new_email'] = "Por favor entre un nuevo email para";
...
$txt['home_personal_saltkey_button'] = "Guardela!";
...
$txt['import_csv_anyone_can_modify_in_role_txt'] = "Activar \"todos el el mismo rol pueden modificar\" en todos los elementos importados.";
...
$txt['import_kp_finished'] = "Importacion desde KeePass ha finalizado!<br />Por default, el nivel de complejidad para nuevas carpetas ha sido establecido en 'Medio'. Quizas necesite cambiarlo.";
$txt['import_to_folder'] = "Seleccione los elementos que quiere importar a la carpeta:";
$txt['index_add_one_hour'] = "Extienda la sesion por 1 hora";
...
$txt['info_click_to_edit'] = "Clickee en la celda para editar este valor";
...
$txt['personal_salt_key_empty'] = "Su salt key personal no ha sido ingresada!";
...
$txt['rights_matrix'] = "Matrix de permisos de usuario";
$txt['roles'] = "Roles";
...
$txt['settings_ldap_domain_controler'] = "Arreglo de controladores de dominio LDAP";
$txt['settings_ldap_domain_controler_tip'] = "<span style='font-size:11px;max-width:300px;'>Especifique multimples controladores si usted quisiera que la clase balancee las consultas LDAP entre los multiples servides.<br />Debe delimitar los dominios con una coma ( , )!<br />Por ejemplo: dominio_1,dominio_2,dominio_3</span>";
...
$txt['settings_log_connections'] = "Habilitar el logging de todas las conecciones de los usuarios a la base de datos.";
$txt['settings_maintenance_mode'] = "Establecer cPassMan en Modo de Mantenimiento";
...
$txt['settings_printing_tip'] = "Una vez habilitado, aparecera un boton en la pagina inicial del usuario que le permitira escribir un listado de items en un archivo PDF que el podra ver. Tenga en cuenta que el listado de claves sera desencriptado.";
...
$txt['update_needed_mode_admin'] = "Es recomendado actualizar su instalacion de cPassMan. Clickee <a href=\"%5C%27install/upgrade.php%5C%27\">AQUI</a>";
