...
echo '
            ...
            if ( empty($_SESSION['last_pw_change']) OR $_SESSION['validite_pw'] == false ){
                ...
                <div style="margin:5px;border:1px solid #FF0000;background-color:#FFFFC0;padding:4px;width:300px;text-align:center;" id="div_changer_mdp">
                    <table>
                        <tr><td>'.$txt['index_new_pw'].' :</td><td><input type="password" size="10" name="new_pw" id="new_pw" onkeyup="runPassword(this.value, \'mypassword\');" />
